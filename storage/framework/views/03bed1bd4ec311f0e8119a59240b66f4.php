<?php $__env->startSection('title', 'Form Pesanan - Cloudywear'); ?>
...
<header class="bg-white border-b border-gray-200 sticky top-0 z-50">
    <div class="container mx-auto px-8 py-4 flex items-center justify-between">
        <a href="<?php echo e(route('user.catalog')); ?>">
            <img src="<?php echo e(asset('images/cloudywear-logo1.png')); ?>" class="h-10 w-auto">
        </a>
...
<div class="max-w-4xl mx-auto p-6 relative">
    ...
    <div id="successModal" 
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-7 w-80 text-center animate-scaleIn">
            ...
            <p class="text-gray-600 mb-2"><?php echo e(session('success')); ?></p>
    ...
    <script>
        ...
        setTimeout(() => {
            window.location.href = "<?php echo e(route('user.catalog')); ?>"; 
        }, 3000);
    </script>
    ...
    <form action="<?php echo e(route('order.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" value="<?php echo e($product->name); ?>" disabled class="w-full border-gray-300 rounded mt-1">
        </div>

        
        <div class="mb-4">
            <label class="font-semibold">Harga</label>
            <input type="text" value="Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?>" disabled class="w-full border-gray-300 rounded mt-1">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\final-project-cloud-computing-a-cc-kelompok-6-cloudy\resources\views/user/order/form.blade.php ENDPATH**/ ?>