    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="container mx-auto px-8 py-4">
            <div class="flex items-center justify-between">
                <!-- Logo -->
                <a href="<?php echo e(route('user.catalog')); ?>" class="flex items-center">
                    <img src="<?php echo e(asset('images/cloudywear-logo1.png')); ?>" 
                        class="h-10 w-auto">
                </a> 
                ...
                <nav class="flex space-x-6">
                    <!-- Semua -->
                    <a href="<?php echo e(route('user.catalog')); ?>"
                    class="<?php echo e(request('category') ? 'text-gray-700' : 'font-bold text-[#0E5DA5]'); ?>">
                        Semua
                    </a>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('user.catalog', ['category' => $category->slug])); ?>"
                        class="<?php echo e(request('category') == $category->slug ? 'font-bold text-[#0E5DA5]' : 'text-gray-700'); ?>">
    ...
    <main class="container mx-auto px-4 md:px-8">
        ...
        <section class="mt-10">
            <div class="relative w-full h-[340px] md:h-[450px] lg:h-[520px] rounded-2xl overflow-hidden shadow-lg">
                ...
                <!-- IMAGE (AUTO-SLIDER) -->
                <img id="heroImage"
                    src="<?php echo e(asset('images/banner1.jpg')); ?>"
        ...
        <script>
            ...
            const heroImages = [
                "<?php echo e(asset('images/banner1.jpg')); ?>",
                "<?php echo e(asset('images/banner2.jpg')); ?>",
                "<?php echo e(asset('images/banner3.jpg')); ?>",
            ];
                            ...
                            <a href="<?php echo e(route('user.product.detail', $product->id)); ?>">
                                <?php if($product->image): ?>
                                    <?php if(str_starts_with($product->image, 'http')): ?>
                                        <img src="<?php echo e($product->image); ?>" class="w-full h-[280px] object-cover">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" class="w-full h-[280px] object-cover">
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-4 flex items-center justify-between">
                                    <span class="text-sm text-gray-600">
                                        Stok:
                                        <span class="font-semibold <?php echo e($product->stock > 10 ? 'text-green-600' : ($product->stock > 0 ? 'text-yellow-600' : 'text-red-600')); ?>">
                                    ...
                                    <?php if($product->stock > 0): ?>                                     
                                        <a href="<?php echo e(route('order.create', $product->id)); ?>" 
    ...
    <footer class="bg-[rgba(14,93,165,0.1)] border-t border-gray-200 mt-5">
        <div class="container mx-auto px-8 py-8">
            ...
            <div class="mt-8 pt-5 border-t border-gray-300 text-center text-gray-600 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> cloudywear. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\laragon\www\Project\final-project-cloud-computing-a-cc-kelompok-6-cloudy\resources\views/user/catalog.blade.php ENDPATH**/ ?>