...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - cloudywear</title>
        ...
        <div class="sidebar" id="sidebar">
            <div class="d-flex align-items-center justify-content-between px-3 pt-3 pb-2">
                <a href="/admin" class="sidebar-brand p-0 m-0 d-flex align-items-center justify-content-center w-100">
                    <img src="<?php echo e(asset('images/cloudywear-logo.png')); ?>" alt="CloudyWear" class="brand-logo">
                </a>
            ...
            <nav class="navbar flex-column mt-3">
                <ul class="navbar-nav w-100">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link <?php echo e($productMenuActive ? '' : 'collapsed'); ?>" data-bs-toggle="collapse"
                            href="#menuProduk">
                            <i class="bi bi-box-seam"></i>
                            <span>Manajemen Produk</span>
                            <i class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <div id="menuProduk" class="collapse <?php echo e($productMenuActive ? 'show' : ''); ?>">
                            <ul class="nav flex-column ms-4">

                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->is('admin/products*') ? 'active' : ''); ?>"
                                        href="/admin/products">
                                        <i class="bi bi-bag"></i>
                                        <span>Produk</span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->is('admin/categories*') ? 'active' : ''); ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('admin/pemesanan*') ? 'active' : ''); ?>"
...
<?php /**PATH C:\laragon\www\Project\final-project-cloud-computing-a-cc-kelompok-6-cloudy\resources\views/layouts/admin.blade.php ENDPATH**/ ?>