...
<div class="container-fluid px-4 py-3" style="margin-top: -0.5rem;">
            ...
            <div class="card shadow-sm border-0 rounded-4 p-3 premium-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold"><?php echo e(number_format($totalProducts)); ?></h3>
                    </div>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-3 premium-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold"><?php echo e(number_format($totalCompletedOrders)); ?></h3>
                    </div>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-3 premium-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold">Rp <?php echo e(number_format($totalProductValue, 0, ',', '.')); ?></h3>
                    </div>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-3 premium-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold">Rp <?php echo e(number_format($totalValue, 0, ',', '.')); ?></h3>
                    </div>
    ...
    <div class="alert shadow-sm border-0 rounded-4 mb-4 p-3 d-flex justify-content-between align-items-center premium-alert">
        ...
        <a href="<?php echo e(route('admin.products.index')); ?>" class="btn premium-btn">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\final-project-cloud-computing-a-cc-kelompok-6-cloudy\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>